  ...
  return (
    <>
      <div
        ...
        className={
          "h-[calc(100vh-110px)] p-5 bg-gradient-to-b from-slate-300 to-slate-100 md:p-10 flex justify-center content-center" +
          props.className
        }
      >
        <div className=" w-[90vw] md:w-[77vw] max-w-[80rem] flex flex-col justify-around">
          ...
          <div className="grow flex flex-col justify-end gap-[1em] h-[35vh]">
