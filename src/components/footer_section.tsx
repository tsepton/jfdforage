...
export default function FooterSection(props: { className: string, currentSection: string, moreInfo: boolean, showContact: boolean; }) {
  ...
  return (
    <div className={"w-[100%] flex flex-col gap-[2em] " + props.className} >
      <div className={highlight + "w-[100%] text-center"}>
        {trans.get("sections.questions")}
      </div>

      <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
        <a href={nextSection} className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
